...
| --- | --- | --- | --- | --- | --- |
| ai | `76c859bda24a` | none | Delegated platform boundary only | None verified | 1 checkout(s) differ from authoritative main |
| ai-config | `d62429c63e9f` | none | Delegated platform boundary only | None verified | 1 checkout(s) differ from authoritative main |
| ai-evals | `dfcbad99c3ed` | none | Delegated platform boundary only | None verified | 1 checkout(s) differ from authoritative main |
...
| ai-providers | `b74c649e6603` | none | Delegated platform boundary only | None verified | 1 checkout(s) differ from authoritative main |
| ai-rag | `9aa6ddf7ab4c` | none | Delegated platform boundary only | None verified | matches authoritative main |
| ai-router | `bb35c9520628` | none | Delegated platform boundary only | None verified | 1 checkout(s) differ from authoritative main |
| ai-speech | `75154cfc3ac6` | none | Delegated platform boundary only | None verified | 1 checkout(s) differ from authoritative main |
| analytics | `abfb338fb16d` | http | RFC3986 (unverified), RFC6585 (unverified), RFC7239 (unverified), RFC8259 (unverified), RFC8288 (unverified), RFC9110 (conformant), RFC9111 (unverified), RFC9112 (unverified), RFC9457 (unverified) | RFC-9110-RETRY-AFTER-PARSING | 2 checkout(s) differ from authoritative main |
...
| profile | `52af1d39e61d` | none | Delegated platform boundary only | None verified | 1 checkout(s) differ from authoritative main |
...
| schema | `18bc4b802917` | structured-data | RFC3339 (unverified), RFC3629 (unverified), RFC4647 (unverified), RFC4648 (unverified), RFC5646 (partial), RFC8259 (unverified), RFC9562 (conformant) | RFC-5646-LANGUAGE-TAG-SUBSET, RFC-9562-UUID-COMPATIBILITY-REFERENCE | 1 checkout(s) differ from authoritative main |
...
| translations | `def5acc842da` | structured-data | RFC3339 (unverified), RFC3629 (unverified), RFC4647 (unverified), RFC4648 (unverified), RFC5646 (partial), RFC8259 (unverified), RFC9562 (unverified) | RFC-5646-LANGUAGE-TAG-SUBSET | 1 checkout(s) differ from authoritative main |
...
| voice | `54dafd29b9ee` | none | Delegated platform boundary only | None verified | matches authoritative main |
